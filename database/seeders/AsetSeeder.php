...
class AsetSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $asets = [
            ...
            // Tambahan data dummy untuk contoh lainnya
            [
                'sub_sub_rincian_objek_id' => $subSubRincianObjeks[0]->id,
                'kode_barang' => $subSubRincianObjeks[0]->kode . '.002',
                'nama_bidang_barang' => 'Kendaraan Operasional Dinas',
                'register' => 'REG006/2023',
                'nama_jenis_barang' => 'SUV Toyota Fortuner',
                'merk_type' => 'Toyota Fortuner 4x4 Diesel',
                'no_sertifikat' => 'SERT006/2023',
                'no_plat_kendaraan' => 'B 5678 XYZ',
                'no_pabrik' => 'TOY987654321',
                'no_casis' => 'CAS987654321',
                'bahan' => 'Logam dan Plastik',
                'asal_perolehan' => 'Pembelian Langsung',
                'tahun_perolehan' => '2023',
                'ukuran_barang_konstruksi' => '4.8m x 1.9m x 1.8m',
                'satuan' => 'Unit',
                'keadaan_barang' => 'Baik',
                'jumlah_barang' => 1,
                'harga_satuan' => 550000000.00,
                'bukti_barang' => null,
                'bukti_berita' => null,
            ],
            [
                'sub_sub_rincian_objek_id' => $subSubRincianObjeks[1]->id,
                'kode_barang' => $subSubRincianObjeks[1]->kode . '.002',
                'nama_bidang_barang' => 'Perangkat Komputer Kantor',
                'register' => 'REG007/2023',
                'nama_jenis_barang' => 'Monitor LG 24 inch',
                'merk_type' => 'LG 24MK600M-B',
                'no_sertifikat' => 'SERT007/2023',
                'no_plat_kendaraan' => null,
                'no_pabrik' => 'LG123456789',
                'no_casis' => null,
                'bahan' => 'Plastik dan Logam',
                'asal_perolehan' => 'Tender Terbuka',
                'tahun_perolehan' => '2023',
                'ukuran_barang_konstruksi' => '54cm x 38cm x 18cm',
                'satuan' => 'Unit',
                'keadaan_barang' => 'Baik',
                'jumlah_barang' => 20,
