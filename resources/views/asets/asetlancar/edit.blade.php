            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Edit Aset Lancar</h4>
                ...
                <div class="card-body">
                    <form action="{{ route('aset-lancar.update', $asetLancar) }}" method="POST" id="asetLancarEditForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('akun') is-invalid @enderror" id="akun" name="akun" required>
                                    ...
                                    @foreach($akuns as $akun)
                                        <option value="{{ $akun->akun }}" {{ (old('akun', $asetLancar->kodeRekening->akun) == $akun->akun) ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('kelompok') is-invalid @enderror" id="kelompok" name="kelompok" required>
                                    <option value="{{ $asetLancar->kodeRekening->kelompok }}" selected>
                                        {{ $asetLancar->kodeRekening->kelompok }} {{ $asetLancar->kodeRekening->nama_kelompok }}
                                    </option>
                                </select>
                                @error('kelompok')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('jenis') is-invalid @enderror" id="jenis" name="jenis" required>
                                    <option value="{{ $asetLancar->kodeRekening->jenis }}" selected>
                                        {{ $asetLancar->kodeRekening->jenis }} {{ $asetLancar->kodeRekening->nama_jenis }}
                                    </option>
                                </select>
                                @error('jenis')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('objek') is-invalid @enderror" id="objek" name="objek" required>
                                    <option value="{{ $asetLancar->kodeRekening->objek }}" selected>
                                        {{ $asetLancar->kodeRekening->objek }} {{ $asetLancar->kodeRekening->nama_objek }}
                                    </option>
                                </select>
                                @error('objek')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('kode_rekening_id') is-invalid @enderror" id="nomor" name="kode_rekening_id" required>
                                    <option value="{{ $asetLancar->kode_rekening_id }}" selected>
                                        {{ $asetLancar->kodeRekening->kode_lengkap }} - {{ $asetLancar->kodeRekening->uraian }}
                                    </option>
                                </select>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="uraian_rekening" value="{{ $asetLancar->kodeRekening->uraian }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('uraian_barang') is-invalid @enderror" id="uraian_barang" name="uraian_barang" value="{{ old('uraian_barang', $asetLancar->uraian_barang) }}" required>
                                @error('uraian_barang')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('nama_kegiatan') is-invalid @enderror" id="nama_kegiatan" name="nama_kegiatan" value="{{ old('nama_kegiatan', $asetLancar->nama_kegiatan) }}" required>
                                @error('nama_kegiatan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control @error('uraian_kegiatan') is-invalid @enderror" id="uraian_kegiatan" name="uraian_kegiatan" rows="3" required>{{ old('uraian_kegiatan', $asetLancar->uraian_kegiatan) }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control @error('uraian_jenis_barang') is-invalid @enderror" id="uraian_jenis_barang" name="uraian_jenis_barang" rows="3" required>{{ old('uraian_jenis_barang', $asetLancar->uraian_jenis_barang) }}</textarea>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('saldo_awal_unit') is-invalid @enderror" id="saldo_awal_unit" name="saldo_awal_unit" value="{{ old('saldo_awal_unit', $asetLancar->saldo_awal_unit) }}" min="0" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('saldo_awal_harga_satuan') is-invalid @enderror" id="saldo_awal_harga_satuan" name="saldo_awal_harga_satuan" value="{{ old('saldo_awal_harga_satuan', $asetLancar->saldo_awal_harga_satuan) }}" min="0" step="0.01" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="mutasi_tambah_unit" name="mutasi_tambah_unit" value="{{ old('mutasi_tambah_unit', $asetLancar->mutasi_tambah_unit) }}" min="0">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="mutasi_tambah_harga" class="form-label">Harga Satuan</label>
                                        <input type="number" class="form-control" id="mutasi_tambah_harga" name="mutasi_tambah_harga" value="{{ old('mutasi_tambah_harga', $asetLancar->mutasi_tambah_harga) }}" min="0" step="0.01">
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="mutasi_kurang_unit" name="mutasi_kurang_unit" value="{{ old('mutasi_kurang_unit', $asetLancar->mutasi_kurang_unit) }}" min="0">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="mutasi_kurang_nilai" class="form-label">Nilai</label>
                                        <input type="number" class="form-control" id="mutasi_kurang_nilai" name="mutasi_kurang_nilai" value="{{ old('mutasi_kurang_nilai', $asetLancar->mutasi_kurang_nilai) }}" min="0" step="0.01">
                                    </div>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    calculateSaldoAwalTotal();
    calculateMutasiTambahNilai();
    calculateSaldoAkhir();

    // Dropdown cascade handlers (same as create form)
