...
<style>
  ...
  .dashboard-icon-wrapper {
    ...
    justify-content: center;
    position: absolute;
    right: -36px; /* ubah dari left ke right */
    top: 50%;
    transform: translateY(-50%);
    box-shadow: 0 2px 8px rgba(0,123,255,0.08);
  }
  .dashboard-card-content {
    margin-right: 56px; /* ubah dari margin-left ke margin-right */
    flex: 1;
  }
...
<div class="dashboard-card-row">
  ...
  <div class="dashboard-card">
    <div class="dashboard-card-content">
      <div class="dashboard-card-title">TOTAL ASET</div>
      <div class="dashboard-card-footer">
        <div class="dashboard-card-value">1.200 Item</div>
      </div>
    </div>
    <div class="dashboard-icon-wrapper">
      <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 24 24" stroke-width="2.5" stroke="#007bff" fill="none" stroke-linecap="round" stroke-linejoin="round">
        <rect x="10" y="4" width="12" height="12" rx="2" />
        <path d="M8 4h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2v-2" />
      </svg>
    </div>
  </div>
  <!-- Card 2 -->
  <div class="dashboard-card">
    <div class="dashboard-card-content">
      <div class="dashboard-card-title">ASET LANCAR</div>
      <div class="dashboard-card-footer">
        <div class="dashboard-card-value">1.200 Item</div>
      </div>
    </div>
    <div class="dashboard-icon-wrapper">
      <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 24 24" stroke-width="2.5" stroke="#007bff" fill="none" stroke-linecap="round" stroke-linejoin="round">
        <path d="M3 3v18h18" /><path d="M7 11h3v8h-3z" /><path d="M11 7h3v12h-3z" /><path d="M15 13h3v6h-3z" />
      </svg>
    </div>
  </div>
</div>
<div class="dashboard-card-row">
  ...
  <div class="dashboard-card">
    <div class="dashboard-card-content">
      <div class="dashboard-card-title">ASET TETAP</div>
      <div class="dashboard-card-footer">
        <div class="dashboard-card-value">1.200 Item</div>
      </div>
    </div>
    <div class="dashboard-icon-wrapper">
      <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 24 24" stroke-width="2.5" stroke="#007bff" fill="none" stroke-linecap="round" stroke-linejoin="round">
        <path d="M9 11l3 3l7 -7" /><path d="M21 12v9a2 2 0 0 1 -2 2h-16a2 2 0 0 1 -2 -2v-9" /><path d="M3 12l9 -9l9 9" />
      </svg>
    </div>
  </div>
  <!-- Card 4 -->
  <div class="dashboard-card">
    <div class="dashboard-card-content">
      <div class="dashboard-card-title">ASET LAINNYA</div>
      <div class="dashboard-card-footer">
        <div class="dashboard-card-value">1.200</div>
      </div>
    </div>
    <div class="dashboard-icon-wrapper">
      <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 24 24" stroke-width="2.5" stroke="#007bff" fill="none" stroke-linecap="round" stroke-linejoin="round">
        <path d="M7 7h.01" /><path d="M17 7h.01" /><path d="M12 12h.01" /><path d="M7 17h.01" /><path d="M17 17h.01" /><path d="M12 22h.01" /><path d="M4 4h16v16h-16z" />
      </svg>
    </div>
  </div>
</div>
